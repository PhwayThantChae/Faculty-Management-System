...
<div class='container'>
	...
	<form class="form-inline" role="form" method="post" action="Admin_DeleteFaculty.php">
	<div class="row">
...
<div class="row">
	<table class='table table-bordered table-striped table-hover bg-info'>
		...
		<?php
			...
			<a href="Admin_DeleteFaculty.php?staffdelete=<?php echo $temp?>& staffDeleteUser=<?php echo $temp_user_type?> " class="btn btn-info btn-sm" role="button" name="delete" >Delete</a></td>
			<?php
			echo "</tr>";
