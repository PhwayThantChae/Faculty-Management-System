...
?>
	...
	<div class='container'>
		...
		<form action="FacultyUpdateProfile.php" method="post" enctype="multipart/form-data" class="form-horizontal">
		...
		<legend><strong>Personal Detail</strong></legend>
				...
				<div class = "form-group">
					<div class = 'row'>
						...
						<div class='col-md-4'>
						<input type = "text" class="form-control input-sm" name="phone" value="<?php echo $row["phone"]  ?>"/>
						</div>
					</div>
				</div>
		...
		<legend><strong>Education Qualification</strong></legend>
			...
			<form action="FacultyUpdateProfile.php" method="post">
				<div class = "form-group">
					<div class = 'row'>
