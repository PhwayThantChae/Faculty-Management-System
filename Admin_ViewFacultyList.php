...
//	
//	include 'DBConnection.php';
//	$id_detail = (int)$_GET["staffdetail"];
	
//	$sqlDetail = "UPDATE staff SET status=0 WHERE staff_id=$id_delete;";
//	$resultsqlDetail = $conn->query($sqlDetail);
//	
...
//	header("Location: Admin_Detail_Button.php?id=$id_detail");
//}
?>
